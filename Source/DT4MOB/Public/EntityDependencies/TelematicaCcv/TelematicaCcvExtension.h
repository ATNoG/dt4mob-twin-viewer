...
#include "TelematicaCcvExtension.generated.h"

/** @brief Type-specific behavior for "telematica-ccv" entities. */
UCLASS()
class DT4MOB_API UTelematicaCcvExtension : public UEntityTypeExtension
{
    GENERATED_BODY()
...
public:
    ...
    virtual FString GetBadgeLabel(const FString& TypeKey) const override { return TEXT("CCV"); }
};
